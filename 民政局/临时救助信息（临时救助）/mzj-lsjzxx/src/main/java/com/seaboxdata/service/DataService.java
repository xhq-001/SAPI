...
public class DataService {
    ...
    static {
        ...
        columnShortMap.put("mingcheng", new ColumnShort("sfzhm", "eq", "名称"));
        columnShortMap.put("quhua", new ColumnShort("sfzhm", "eq", "区划"));
        columnShortMap.put("leixing", new ColumnShort("sfzhm", "eq", "类型"));
...
//                columns = TitleUtil.buildTitle(authField, columnShortMap);
        ...
        try {
            resultInfo = accessInterface.obtainData(pageNo, pageSize, search, null,columns);
